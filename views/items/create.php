    ...
    <form action="?action=items/create" method="post" enctype="multipart/form-data" class="space-y-5">
        <div>
            ...
            <input type="text" name="name" id="name"
                ...
                value="<?= isset($_SESSION['old']['name'])? $_SESSION['old']['name']:'' ?>" required>
        </div>
        ...
        <div>
            ...
            <input type="number" name="quantity" id="quantity"
                class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                value="<?= isset($_SESSION['old']['quantity'])? $_SESSION['old']['quantity']:'' ?>" required>
        </div>
        ...
        <div>
            ...
            <input type="number" name="price" id="price"
                class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                value="<?= isset($_SESSION['old']['price'])? $_SESSION['old']['price']:'' ?>" required>
        </div>
